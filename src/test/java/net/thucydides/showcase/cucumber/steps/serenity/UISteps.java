...
public class UISteps extends ScenarioSteps {
    ...
    public void click_on_offer_details_link() {
           homepage.clickOnOfferDetailsLink();
    }

    @Step 
    public void verifyOfferDetails() {
            offerDatailsPage.verify_Offer_Details_text();
    }
   ...
   @Step
    ...
    @Step
    public void verifyErrorMessage1(String errorMessage) {
        signInPage.verifyErrorMessage1(errorMessage);
    }

    @Step 
    public void select_channels_option() {
        homepage.clickOnselectchannelsoption();
    }

    @Step
    public void should_see_list_of_channels_available() {
        homepage.assertlistofchannels();
    }

    @Step 
    public void i_select_channels_option() {
        homepage.clickOniselectchannelsoption();
    }

    @Step
    public void i_should_see_list_of_channels_available() {
        homepage.assertlistofchannelsavailable();
    }
}
