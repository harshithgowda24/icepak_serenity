...
public class SignInPage extends PageObject {
    ...
    @FindBy(how = How.XPATH, using = "//span[contains(.,'Invalid email/password combination')]")
    private static WebElement invalidError =null;
    ...
    public void verifyErrorMessage1(String errorMessage) {
       assertEquals(errorMessage,invalidError.getText());
    }
